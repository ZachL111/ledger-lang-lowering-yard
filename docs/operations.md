...
`ledger-lang-lowering-yard` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for lowering workflows, centered on security rule linting, safe and unsafe fixtures, and remediation hints.
...
The score is deterministic. The current threshold is 154. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
